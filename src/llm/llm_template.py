...
class LlmTemplate:
    role = dedent(
        """
        You are a AI vision model tasked with identifying objects in images for an educational web app about ocean
    ...
    def describe_image_prompt() -> str:
        return dedent(
            ...
            Follow these guidelines when identifying objects:
                ...
                4. If you can't identify the entire object, respond with `UNRECOGNIZED`.
            ...
            - Do not attempt to identify the whole object or guess at what it might be; instead, describe the visible
              part in its most basic form.
